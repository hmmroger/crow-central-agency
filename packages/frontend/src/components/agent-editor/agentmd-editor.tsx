      ...
      {previewing ? (
        ...
        >
          ...
          <textarea
            ...
            className="flex-1 py-3 pl-3 pr-3 text-sm font-mono text-text-base bg-transparent placeholder:text-text-muted focus:outline-none resize-none overflow-y-auto"
          />
        </div>
      )}
    </div>
