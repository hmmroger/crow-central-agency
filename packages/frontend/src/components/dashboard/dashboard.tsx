  ...
  if (agents.length === 0) {
    return (
      <div className="h-full flex flex-col items-center justify-center gap-4 text-text-muted">
        ...
        <button
          className="px-4 py-2 rounded-md bg-primary text-base font-medium hover:opacity-90 transition-opacity"
  ...
  return (
    <div className="h-full overflow-y-auto p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          className="px-3 py-1.5 rounded-md bg-primary text-base text-sm font-medium hover:opacity-90 transition-opacity"
          onClick={() => goToAgentEditor()}
        >
          + New Agent
        </button>
