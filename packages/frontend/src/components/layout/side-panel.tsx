...
export function SidePanel() {
  ...
  if (!sidePanelOpen) {
    return (
      <button
        type="button"
        className="fixed right-0 top-1/2 -translate-y-1/2 z-10 p-1.5 rounded-l-md bg-surface/60 backdrop-blur-sm border border-r-0 border-border-subtle/30 text-text-muted hover:text-text-primary hover:bg-surface-elevated/80 transition-colors"
  ...
  return (
    <div className="relative shrink-0 flex" style={{ width: sidePanelWidth }}>
      <PanelResizeHandle
