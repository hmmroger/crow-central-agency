      ...
      case "action": {
        ...
        return (
          <button
            ...
            className={cn(
              "flex w-full items-center gap-2 px-3 py-2 rounded-md text-left text-sm transition-colors",
              isSelected
  ...
  return (
    <FloatingFocusManager context={context} modal={false}>
      <motion.div
        ...
        style={{ ...config.style, ...floatingStyles }}
        className={cn(
          "z-50 overflow-y-auto rounded-xl border border-border bg-surface p-1 shadow-elevated focus:outline-none",
          config.className
        )}
        {...getFloatingProps()}
