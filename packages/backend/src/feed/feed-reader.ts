...
function extractFeedItems(
  ...
  itemArray.forEach((item) => {
    ...
    const publishedTime = parseDate(
      getElement<string>(item, XmlTags.pubDate) ||
        getElement<string>(item, XmlTags.published) ||
        getElement<string>(item, XmlTags.updated)
    );
