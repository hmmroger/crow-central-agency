  ...
  content: [
    {
      content: [
        ...
        "  character, its inner voice and temperament, the register and manner in which it speaks, and — when",
        "  the agent is framed as a particular kind of being or a member of a group — the social and cultural",
        "  sensibilities and constraints that framing carries. It is identity, not procedure: keep workflows,",
        "  tool usage, step-by-step decision rules, and operating conventions out, as those belong in the",
        "  AGENT.md. A strong persona reads as one coherent character in a few short paragraphs of cohesive",
        "  prose (aim for roughly 200 words or fewer) — no labeled sections, no bold headers, and no checklist",
        "  of dimensions or list of adjectives.",
