...
async function createTask(
  ...
  return [
    ...
    "Must NOT answer from your own knowledge in the meantime, and do not reply in fragments as each delegated result arrives. Once all outstanding results are in, consolidate them into a single final response.",
  ].join(" ");
}
