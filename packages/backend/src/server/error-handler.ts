...
import { APP_ERROR_CODES, type AppErrorCode } from "../core/error/app-error.types.js";
...
const HTTP_STATUS_MAP: Record<AppErrorCode, number> = {
  ...
  [APP_ERROR_CODES.NOT_SUPPORTED]: 400,
  ...
  [APP_ERROR_CODES.INVALID_FILENAME]: 400,
  [APP_ERROR_CODES.CONFLICT]: 409,
  [APP_ERROR_CODES.MCP_CONFIG_NOT_FOUND]: 404,
  [APP_ERROR_CODES.MCP_ERROR]: 502,
  [APP_ERROR_CODES.SDK_ERROR]: 502,
  [APP_ERROR_CODES.WS_ERROR]: 500,
  [APP_ERROR_CODES.CIRCLE_NOT_FOUND]: 404,
  [APP_ERROR_CODES.FRAGMENT_NOT_FOUND]: 404,
  [APP_ERROR_CODES.RELATIONSHIP_NOT_FOUND]: 404,
  [APP_ERROR_CODES.DUPLICATE_RELATIONSHIP]: 409,
  [APP_ERROR_CODES.CIRCLE_IMMUTABLE]: 403,
  [APP_ERROR_CODES.CIRCULAR_MEMBERSHIP]: 409,
  [APP_ERROR_CODES.LAST_CIRCLE_MEMBERSHIP]: 409,
  [APP_ERROR_CODES.TEXT_GEN_PROVIDER_ERROR]: 500,
  [APP_ERROR_CODES.AUDIO_GEN_NO_DATA]: 502,
  [APP_ERROR_CODES.FEED_ERROR]: 500,
  [APP_ERROR_CODES.FEED_FETCH_ERROR]: 502,
  [APP_ERROR_CODES.FEED_INVALID]: 400,
  [APP_ERROR_CODES.PLACES_SOURCE_NOT_REGISTERED]: 400,
  [APP_ERROR_CODES.TIMEOUT]: 500,
};
