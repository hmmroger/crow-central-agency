...
const FRAGMENT_PARENT_KINDS: Record<FragmentKind, ReadonlySet<FragmentKind>> = {
  [FRAGMENT_KIND.FEEDBACK]: new Set([FRAGMENT_KIND.FEEDBACK, FRAGMENT_KIND.LESSON, FRAGMENT_KIND.DOMAIN]),
  [FRAGMENT_KIND.LESSON]: new Set([FRAGMENT_KIND.FEEDBACK, FRAGMENT_KIND.LESSON, FRAGMENT_KIND.DOMAIN]),
